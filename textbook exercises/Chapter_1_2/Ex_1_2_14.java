...
public class Ex_1_2_14 {
    public static class Transaction {
        ...
        public boolean equals(Object x) {
            ...
            if (that.who() != this.who())
                return false;
            if (that.when() != this.when())
                return false;
            if (that.amount() != this.amount())
                return false;
            return true;
        }
    ...
    public static void main(String[] args) {
        ...
        Transaction transaction1 = new Transaction("A", date, 999.0);
        Transaction transaction2 = new Transaction("Alice", date, 1000.0);

        boolean result1 = transaction.equals(transaction1);
        boolean result2 = transaction.equals(transaction2);
        if (!result1 && !result2) {
